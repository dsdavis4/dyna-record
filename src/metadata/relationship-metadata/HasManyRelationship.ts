 ...
 * @property {ForeignKeyAttribute} foreignKey - The attribute in the associated entity that serves as a foreign key, linking back to the primary key of the owning entity. This key is essential for maintaining the integrity of the "HasMany" relationship.
 *
