 ...
 * @property {ForeignKeyProperty} foreignKey - The attribute in the associated entity that functions as a foreign key, establishing a link back to the primary key of the owning entity. This key is vital for maintaining the relationship's integrity and navigability.
 *
