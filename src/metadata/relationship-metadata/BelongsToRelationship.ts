 ...
 * @property {ForeignKeyAttribute} foreignKey - The attribute representing the foreign key in the relationship. This specifies the field in the entity that links to another entity, serving as the cornerstone for relationship queries and operations.
 *
