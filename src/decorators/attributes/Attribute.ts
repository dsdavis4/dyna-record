 ...
 * @param props An object of {@link AttributeProps}, which includes configuration options like `alias`, specifying an alternative name for the attribute in the database.
...
function Attribute<T, K extends NativeScalarAttributeValue>(
  props?: AttributeProps // TODO should not accept optional and add a test for it
) {
  return function (
    _value: undefined,
