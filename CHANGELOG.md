...
- **`DynaRecord` gains static and instance `search` methods.** Subclasses that happened to define their own `search` member now collide with the base class; rename or align with the new signatures when upgrading.
